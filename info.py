...
PICS = (environ.get('PICS', 'https://telegra.ph/file/979a3883871d79383c9bc.jpg https://telegra.ph/file/979a3883871d79383c9bc.jpg')).split() #SAMPLE PIC
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{file_name} {file_size} @armoviechat Make sure you are downloading the right language and use VLC Media Player to switch audio in multi-audio files !")
